...
GUI::GUI(QWidget *parent)
{
    ...
    grid->addWidget(label, 4,4, Qt::AlignBottom);
    setLayout(grid);
    setWindowTitle("Assesment");
    setStyleSheet("background-color: white");
    setUpdatesEnabled(true);
    resize(320,320);
    //grid->addWidget(this,0,1);
...
//@Param QPointF rect: QPoint object(x,y) being used to calculate distance from the origin of the circle.
